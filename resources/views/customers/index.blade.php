...
<div class="container" data-testid="customers-index">
    ...
    <div class="card" data-testid="customers-duplicates-center-card">
    ...
    <div class="card" data-testid="customers-permissions-card">
        <h2>صلاحيات الوصول</h2>
        <div class="muted">راجع صلاحيات الأدوار المتعلقة بالعملاء والموردين.</div>
        <div class="actions">
            <a href="{{ route('party-permissions.index') }}" class="btn secondary" data-testid="customers-permissions-link">عرض الصلاحيات</a>
        </div>
    </div>
