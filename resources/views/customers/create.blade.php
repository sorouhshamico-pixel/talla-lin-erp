...
<body>
<div class="container" data-testid="customers-create">
    <div class="card">
        <h1>إضافة عميل</h1>
        <div class="muted">أدخل بيانات العميل الأساسية.</div>
    </div>

    <div class="card">
        <form method="POST" action="{{ route('customers.store') }}" data-testid="customers-create-form">
            @csrf
