@extends('layouts.admin', [
    'title' => 'تسجيل دفعة شراء | طلة لين ERP',
    'header' => 'تسجيل دفعة شراء'
])

@section('content')
    <div class="page-header">
        <div>
            <h1 class="page-title">تسجيل دفعة للمورد</h1>
            <div class="muted">
                الفاتورة:
    ...
    <div class="card">
        <form method="POST" action="{{ route('purchase-invoices.payments.store', $invoice) }}">
            @csrf
