...
<div class="container" data-testid="suppliers-index">
    ...
    <div class="card" data-testid="suppliers-dashboard-card">
        ...
        <div class="actions">
            <a href="{{ route('party-dashboard.index') }}" class="btn secondary" data-testid="suppliers-dashboard-link">فتح لوحة العملاء والموردين</a>
        </div>
    </div>
