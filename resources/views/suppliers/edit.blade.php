...
<body>
<div class="container" data-testid="suppliers-edit">
    <div class="card">
        <h1>تعديل مورد</h1>
        <div class="muted">تحديث بيانات المورد الأساسية.</div>
    </div>

    <div class="card">
        <form method="POST" action="{{ route('suppliers.update', $supplier->id) }}" data-testid="suppliers-edit-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                ...
                <div>
                    ...
                    <input id="tax_number" type="text" name="tax_number" value="{{ old('tax_number', $supplier->tax_number) }}">
                ...
                <div>
                    ...
                    <select id="is_active" name="is_active">
                        <option value="1" @selected((string) old('is_active', (int) $supplier->is_active) === '1')>نشط</option>
                        <option value="0" @selected((string) old('is_active', (int) $supplier->is_active) === '0')>غير نشط</option>
                    </select>
            ...
            <div class="actions">
                <button type="submit" class="btn">تحديث المورد</button>
