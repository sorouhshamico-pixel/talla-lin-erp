...
(() => {
    const initializeAuditMetricsHealth = () => {
        ...
        const renderManualRefreshOutcomeSummaryCopySuccesses = () => {
            ...
            manualRefreshOutcomeSummaryCopySuccessCount = safeValue;
            manualRefreshOutcomeSummaryCopySuccesses.textContent =
                String(safeValue);
        };

        const recordManualRefreshOutcomeSummaryCopySuccess = () => {
            manualRefreshOutcomeSummaryCopySuccessCount = Math.min(
        ...
        const renderManualRefreshOutcomeSummaryCopyFailures = () => {
            ...
            manualRefreshOutcomeSummaryCopyFailureCount = safeValue;
            manualRefreshOutcomeSummaryCopyFailures.textContent =
                String(safeValue);
        };

        const recordManualRefreshOutcomeSummaryCopyFailure = () => {
            manualRefreshOutcomeSummaryCopyFailureCount = Math.min(
