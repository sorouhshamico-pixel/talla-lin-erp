...
@section('content')
    <div class="container">
        ...
        @include('reports.partials.active-saved-view-banner', ['savedViews' => $supplierAgingSavedViews])
                ...
                'testId' => 'supplier-aging-saved-views-empty',
            ])
                        @else
                                    ...
                                    <div class="saved-view-row{{ $isActiveSavedView ? ' active-saved-view-row' : '' }}" data-testid="supplier-aging-saved-view-item">
                                        ...
                                        <span class="saved-view-badges">
                                                                                    @if ($isActiveSavedView)
                                                                                        <span class="saved-view-badge saved-view-badge-active" data-testid="supplier-aging-saved-view-active-badge">نشط</span>
                                                                                    @endif

                                                                                    @if ($savedView->is_default)
                                                                                        <span class="saved-view-badge saved-view-badge-default" data-testid="supplier-aging-saved-view-default-badge">افتراضي</span>
                                                                                    @endif
                                        </span>
                                    </div>
                                @endforeach
