...
class SalesInvoiceAgingReportSavedViewSelectorTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_sales_invoice_aging_report_shows_empty_saved_views_selector(): void
    {
    ...
    public function test_sales_invoice_aging_report_lists_saved_views_for_current_report(): void
    {
        $user = User::query()->firstOrFail();
        ...
        $response->assertSee('عرض افتراضي لفواتير المبيعات');
