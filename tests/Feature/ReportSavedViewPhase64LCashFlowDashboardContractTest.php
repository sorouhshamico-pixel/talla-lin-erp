...
class ReportSavedViewPhase64LCashFlowDashboardContractTest extends TestCase
{
    public function test_phase_64l_contract_files_exist(): void
    {
        $this->assertFileExists(base_path('docs/phase-64l-cash-flow-dashboard-saved-view-controls-contract.json'));
        $this->assertFileExists(base_path('docs/phase-64l-cash-flow-dashboard-saved-view-controls-contract.md'));
    }

    public function test_phase_64l_contract_matches_phase_64k_locked_target(): void
    {
        $lock = json_decode(
        ...
        $contract = json_decode(
            file_get_contents(base_path('docs/phase-64l-cash-flow-dashboard-saved-view-controls-contract.json')),
            true
        );

        $this->assertSame('Phase 64L', $contract['phase']);
        $this->assertSame('cash-flow-dashboard', $contract['target']['key']);
    ...
    public function test_phase_64l_contract_target_view_and_controller_exist(): void
    {
        $contract = json_decode(
            file_get_contents(base_path('docs/phase-64l-cash-flow-dashboard-saved-view-controls-contract.json')),
            true
    ...
    public function test_phase_64l_contract_uses_saved_view_controls_conventions(): void
    {
        $contract = json_decode(
            file_get_contents(base_path('docs/phase-64l-cash-flow-dashboard-saved-view-controls-contract.json')),
            true
        ...
        $this->assertSame('cash-flow-dashboard', $registryKey);
    ...
    public function test_phase_64l_contract_documents_routes_hidden_fields_and_test_ids(): void
    {
        $contract = json_decode(
            file_get_contents(base_path('docs/phase-64l-cash-flow-dashboard-saved-view-controls-contract.json')),
            true
        ...
        $this->assertSame('reports.cash-flow-dashboard.saved-views.store', $contract['contract']['saved_view_store_route']);
    ...
    public function test_phase_64l_contract_is_documented(): void
    {
        $contract = json_decode(
            file_get_contents(base_path('docs/phase-64l-cash-flow-dashboard-saved-view-controls-contract.json')),
            true
        ...
        $doc = file_get_contents(base_path('docs/phase-64l-cash-flow-dashboard-saved-view-controls-contract.md'));

        $this->assertStringContainsString('Phase 64L', $doc);
        $this->assertStringContainsString('cash-flow-dashboard', $doc);
        ...
        $this->assertStringContainsString('ReportSavedViewPhase64LCashFlowDashboardContractTest', $doc);
    }
}
